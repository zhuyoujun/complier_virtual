...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        if opponent_score < 10:
            turn_score = 1 + opponent_score
        else:
            turn_score = 1 + abs(opponent_score % 10 - opponent_score // 10)
    else:
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    "*** YOUR CODE HERE ***"
    assert score0 >=0 and score0 <= 100,'The score0 should be in 0~100.'
    assert score1 >=0 and score1 <= 100,'The score1 should be in 0~100.'
    #score0,score1,player = bid_for_start(score0, score1, goal)

    #dice = strategy0(score0, score1)
    t#ake_turn(num_rolls, opponent_score, dice):
